#!/usr/bin/env python3
# Rule-level validation: heatmap (theta_out x phi_out) and polar comparison of the measured
# (real runtime sampling) vs stored-LUT reflected distribution. Reads data/valid_<a>.txt
# (from validate_lut), writes figures/validation_polar.png. (The 3D lego heatmap is plot_lego.py.)
...
for i,a in enumerate(ANG):
    ...
    ax.plot(np.radians(thc),m,'o',color="tab:red",ms=3,label="measured")
